...
.args <- c("../tests/abc_ebola_sim_nobias.json", "../tests/test_abc_example_nobias.sqlite", "digested_stratify_nobias.rds")
...
pars$realized_coverage <- NULL

id.vars <- c(parcols, "index")
